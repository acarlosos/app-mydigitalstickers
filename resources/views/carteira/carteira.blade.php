...
<div class="row  mt-3">
    <div class="col-lg-12">
        <div class="ibox">
            <div class="ibox-content p-md">
                <h3>Aluno: {{$Usuario->UsuarioNome}} <span class="float-right">Saldo: {{$AlunoCarteiraTot}}</span></h3>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example" >
                        ...
                        <tbody>
                            @foreach ($AlunoCarteira as $dados)
                                <tr  class="{{$dados->Action == 'Compra' ?  'text-danger' : ''}} ">
                                    <td>
                                    ...
                                    <td class="text-center">
                                        {{ $dados->Action == 'Compra' ?   floatval(-$dados->QTD) : floatval($dados->QTD)}}
                                    </td>
                                    <td>
