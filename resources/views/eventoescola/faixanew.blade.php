...
@section('content')
    <form role="form" method="post" action="{{url('eventoescola/eventofaixa/faixagravar/'.$eventoEscola->EventoEscolaID)}}">
        @csrf
                ...
                <div class="form-group">
                    ...
                    <div  id="ParamDataIni" class="form-group">
                        ...
                        <div class="input-group " id="calendarioIni">
                            <input type="date" class="form-control" name="FaixaEventoDTIni" value="{{old('FaixaEventoDTIni')}}" placeholder="dd/mm/aaaa" required>
                    ...
                    <div  id="ParamDataFim" class="form-group">
                        ...
                        <div class="input-group " id="calendarioFim">
                            <input type="date" class="form-control" name="FaixaEventoDTFim" value="{{old('FaixaEventoDTFim')}}" placeholder="dd/mm/aaaa" required>
                            <div class="input-group-addon">
                                <span class="glyphicon glyphicon-th"></span>
                            </div>
                        </div>
                    ...
                    <div id="ParamNumIni" class="form-group">
                        ...
                        <input type="number" class="form-control" name="FaixaEventoNumIni" value="{{old('FaixaEventoNumIni')}}"   min="1" max="100" required />
                    </div>
                    <div id="ParamNumFim" class="form-group">
                        <label for="DataFIm">Número Final</label>
                        <input type="number" class="form-control" name="FaixaEventoNumFim" value="{{old('FaixaEventoNumFim')}}" min="1" max="100" required />
                    </div>
                    @endif
                </div>
                <div class="form-group">
                    <label for="DataFIm">Pontuação</label>
                    <input type="number" class="form-control" name="FaixaEventoPontoQuantidade" value="{{old('FaixaEventoPontoQuantidade')}}" min="1" max="100" />
                </div>
                <div class="form-group">
