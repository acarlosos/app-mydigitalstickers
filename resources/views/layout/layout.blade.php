                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        @else
                            <?php $nome = $menu; ?>
                        @endif
                        <img alt="image" class="rounded-circle text-center" width="90px" src="{{ asset(session()->get('UsuarioFoto'))}}"/>
                ...
                @foreach ( $menu as $key =>  $menuItem )
                    ...
                    @if('eventoescola' == $menuItem->Tela)
                        <li id="eventoescola" data-id="{{$key}}">
                            <a href="{{ route('eventoescola.list') }}"><i class="fa fa-address-book"></i> <span class="nav-label"> Administrar faixa de eventos / Repasse de pontos</span></a>
                        </li>
                    @endif
                    ...
                    @if('usuarioescola' == $menuItem->Tela)
                        <li id="usuarioescola" data-id="{{$key}}">
                            <a href="{{ route('usuarioescola.list') }}"><i class="fa fa-user-circle-o"></i> <span class="nav-label">Usuário por escola</span></a>
                        </li>
                    @endif
                    @if('ponto' == $menuItem->Tela)
                        <li id="ponto">
                            <a href="{{ route('ponto.list') }}"><i class="fa fa-eercast"></i> <span class="nav-label">Pontos da escola</span></a>
                        </li>
                    @endif
